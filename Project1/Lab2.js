...
function color() {
	...
	if (s1 == "" && s2 == "" && s4 == "" && s5 == "") {
		...
		document.getElementById("label1").innerHTML = "You need to put the Email!";
		document.getElementById("label2").style.color = "red";
		document.getElementById("label1").innerHTML = "You need to put the Name!";
		document.getElementById("label3").style.color = "red";
		document.getElementById("label1").innerHTML = "You need to put the Date!";
		document.getElementById("label4").style.color = "red";
		document.getElementById("label1").innerHTML = "You need to put the Adress!";
...
var check = function() {
  if (document.getElementById('password2').value ==
    ...
    document.getElementById('message').style.color = 'white';
    document.getElementById('message').innerHTML = ' X Not Matching';
  }
}
...
var check2 = function() {
  ...
  if(myInput.value.length >= 8){
    ...
    document.getElementById('message2').style.color = 'white';
    document.getElementById('message2').innerHTML = 'X At least 8 or more characters';
  }
...
var check3 = function() {
  ...
  if(myInput2.value.match(/^[a-z0-9]+$/i)) {
    ...
    document.getElementById('message3').style.color = 'white';
    document.getElementById('message3').innerHTML = 'X Must Be Alphanumeric';
  }
